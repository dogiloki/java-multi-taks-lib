...
public class DownloadDialog extends javax.swing.JDialog implements Runnable{
    ...
    public DownloadDialog(java.awt.Frame parent, boolean modal, String folder, String name, String url, String msg) {
        super(parent,modal);
        initComponents();
    ...
    public static void main(String args[]){
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DownloadDialog dialog = new DownloadDialog(new javax.swing.JFrame(),true,null,null,null,null);
